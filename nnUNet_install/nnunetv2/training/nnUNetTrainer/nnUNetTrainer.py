...
class nnUNetTrainer(object):
        ...
        if self.local_rank == 0:
            try:
                ...
                make_dot(tuple(self.network(torch.rand((1, self.num_input_channels,
                    ...
                    join(self.output_folder, "network_architecture_1.pdf"), format='pdf')
    ...
    def on_train_start(self):
        ...
        print("####################################################################################################")
        print("The error from here:")
        # produces a pdf in output folder
        self.plot_network_architecture()
        print("Until here are from the plot_network_architecture() -> Not important!!! ")
        print("####################################################################################################")
    ...
    def load_checkpoint(self, filename_or_checkpoint: Union[dict, str]) -> None:
        ...
        if isinstance(filename_or_checkpoint, str):
            print(f"filename_or_checkpoint: {filename_or_checkpoint}")
